...
public abstract class MyAsyncTask<Params, Progress, Result> {
     ...
     *
     * @throws IllegalStateException If {@link #getStatus()} returns either {@link MyAsyncTask.Status#RUNNING} or {@link MyAsyncTask.Status#FINISHED}.
     */
     ...
     * obscure data loss and stability issues. Such changes are best executed in serial; to guarantee such work is serialized regardless of platform version you can use this function with {@link #}.
     *
     * <p>
     * This method must be invoked on the UI thread.
     *
